...
public abstract class Critter {
	...
	// The default return value for eating is false
	public boolean eat() {
		return false;
	}

	// The default attack value is to forfeit
	//parameter:
	//		opponent - Takes in the type of opponent that the animal will fight against
	public Attack fight(String opponent) {
		return Attack.FORFEIT;
	}

	// The default return value for an animal's color is black
	public Color getColor() {
		return Color.BLACK;
	}

	// The default returned movement of an animal is to stay still (center)
	public Direction getMove() {
		return Direction.CENTER;
	}

	// The default symbol that an animal is displayed as is "?"
